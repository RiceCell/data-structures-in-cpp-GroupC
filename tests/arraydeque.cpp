...
3.1. Deque autofills with random integers in each index: [0-1000]
...
void run_randomizer_benchmark(long long N, int containInput) {
    ArrayDeque<int> deque;
    ...
    bool found = deque.contains(containInput);
